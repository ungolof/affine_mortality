...
co_asc_GMki <- function(mu_bar, x0=c(2.191140e-03, -8.855686e-03), delta=c(-5.175933e-02, -5.175921e-02), kappa=c(3.455255e-02, 1.075876e-02), gamma=0.11, sigma=c(6.789215e-04, 2.036748e-03), r=exp(c(-3.345631e+01, -6.015438e-01, -1.557244e+01)), max_iter=200, tol_lik=0.1){
...
co_asc_GMkd <- function(mu_bar, x0=c(2.191140e-03, -8.855686e-03), delta=c(-5.175933e-02, 4.578315e-01, -5.175921e-02), kappa=c(3.455255e-02, 1.075876e-02), gamma=0.11, sigma_dg=c(6.789215e-04, 2.036748e-03), Sigma_cov=-1.260778e-06, r=exp(c(-3.345631e+01, -6.015438e-01, -1.557244e+01)), max_iter=200, tol_lik=0.1){
...
co_asc_AFGNSi <- function(mu_bar, x0=c(1.091714e-02, 1.002960e-02, 5.990785e-04, 0, 0), delta=c(-8.304334e-02, -0.05), kappa=c(9.154603e-03, 1.067658e-02, 7.439715e-03, 0.003, 0.001), sigma=exp(c(-7.318991, -7.535594, -8.456025, -7, -7)), r=exp(c(-3.371775e+01, -5.887962e-01, -1.548729e+01)), max_iter=200, tol_lik=0.1){
...
co_asc_AFUNSi <- function(mu_bar, x0=c(1.091714e-02, 1.002960e-02, -5.990785e-04), delta=c(-1.305830e-06, -5.220474e-02, -1.013210e-01), kappa=c(9.154603e-03, 1.067658e-02, 7.439715e-03), sigma=exp(c(-7.318991, -7.535594, -8.456025)), r=exp(c(-3.371775e+01, -5.887962e-01, -1.548729e+01)), max_iter=200, tol_lik=0.1){
...
co_asc_AFRNSi <- function(mu_bar, x0=c(1.091714e-02, 1.002960e-02), delta=-8.304334e-02, kappa=c(9.154603e-03, 1.067658e-02), sigma=exp(c(-7.318991, -7.535594)), r=exp(c(-3.371775e+01, -5.887962e-01, -1.548729e+01)), max_iter=200, tol_lik=0.1){
  ...
  return(list(par_est = list(x0=CA_par[iter_count,1:2], delta=CA_par[iter_count,3], kappa=CA_par[iter_count,4:5], sigma=CA_par[iter_count,6:7], r1=CA_par[iter_count,8], r2=CA_par[iter_count,9], rc=CA_par[iter_count,10]), log_lik = CA_par[iter_count,length(c(x0, delta, kappa, sigma, r))+1], CA_table = CA_par[1:iter_count,]))
}
