...
CovEst_MI_AFGNSi <- function(x0, delta, kappa, sigma, r, mu_bar, D_se=50, max_it=200, tolerance_lev=0.1){
  ...
  for(d in 1:D_se){
    ...
    hessian_comp <- hessian(nLL_AFGNSi_serr_H, c(p_opt_se$delta, p_opt_se$kappa, p_opt_se$l_sigma, p_opt_se$l_r), method="Richardson", mu_bar=mu_bar, X_rnd_H=X_rnd)
...
CovEst_MI_AFGNSd <- function(x0, delta, kappa, sigma_dg, Sigma_cov, r, mu_bar, D_se=50, max_it=200, tolerance_lev=0.1){
  ...
  for(d in 1:D_se){
    ...
    hessian_comp <- hessian(nLL_AFGNSd_serr_H, c(p_opt_se$delta, p_opt_se$kappa, p_opt_se$dg_l_Sigma_chol, p_opt_se$odg_Sigma_chol1, p_opt_se$odg_Sigma_chol2, p_opt_se$l_r), method="Richardson", mu_bar=mu_bar, X_rnd_H=X_rnd)
